...
// ======================================================================
#import "CubeViewController3.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "CubeBehaviour3.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface CubeViewController3 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<CubeBehaviour3*>* behaviours;
@end
@implementation CubeViewController3
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<CubeBehaviour3*> alloc] init];
    for (int i = 0; i < 1; i++) {
        CubeBehaviour3* behaviour = [[CubeBehaviour3 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (CubeBehaviour3* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
