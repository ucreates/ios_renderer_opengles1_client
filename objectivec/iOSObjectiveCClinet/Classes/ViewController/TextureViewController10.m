...
// ======================================================================
#import "TextureViewController10.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour10.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController10 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour10*>* behaviours;
@end
@implementation TextureViewController10
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour10*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour10* behaviour = [[TextureBehaviour10 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour10* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
