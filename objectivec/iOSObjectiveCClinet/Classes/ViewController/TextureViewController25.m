...
// ======================================================================
#import "TextureViewController25.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour25.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController25 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour25*>* behaviours;
@end
@implementation TextureViewController25
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour25*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour25* behaviour = [[TextureBehaviour25 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour25* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
