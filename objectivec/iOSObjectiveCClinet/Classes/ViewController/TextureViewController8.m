...
// Cube1
// ======================================================================
#import "TextureViewController8.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour8.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController8 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour8*>* behaviours;
@end
@implementation TextureViewController8
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour8*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour8* behaviour = [[TextureBehaviour8 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour8* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
