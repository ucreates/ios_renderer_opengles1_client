...
// ======================================================================
#import "TextureViewController9.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour9.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController9 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour9*>* behaviours;
@end
@implementation TextureViewController9
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour9*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour9* behaviour = [[TextureBehaviour9 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour9* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
