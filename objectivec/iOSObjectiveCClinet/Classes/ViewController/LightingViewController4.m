...
// ======================================================================
#import "LightingViewController4.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "SphereBehaviour1.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface LightingViewController4 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<SphereBehaviour1*>* behaviours;
@end
@implementation LightingViewController4
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    [light setAmbient:[[GLESColor alloc] init:0.0f g:0.0f b:0.0f a:1.0f]];
    [light setDiffuse:[[GLESColor alloc] init:1.0f g:1.0f b:1.0f a:1.0f]];
    ...
    self->behaviours = [[NSMutableArray<SphereBehaviour1*> alloc] init];
    for (int i = 0; i < 1; i++) {
        SphereBehaviour1* behaviour = [[SphereBehaviour1 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (SphereBehaviour1* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
