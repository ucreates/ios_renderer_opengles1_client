...
// Cube1
// ======================================================================
#import "TextureViewController7.h"
...
@interface TextureViewController7 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour7*>* behaviours;
@end
@implementation TextureViewController7
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour7*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour7* behaviour = [[TextureBehaviour7 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour7* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
