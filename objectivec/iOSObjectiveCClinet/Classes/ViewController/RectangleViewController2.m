...
// ======================================================================
#import "RectangleViewController2.h"
...
@interface RectangleViewController2 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<RectangleBehaviour2*>* behaviours;
@end
@implementation RectangleViewController2
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<RectangleBehaviour2*> alloc] init];
    for (int i = 0; i < 1; i++) {
        RectangleBehaviour2* behaviour = [[RectangleBehaviour2 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (RectangleBehaviour2* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
