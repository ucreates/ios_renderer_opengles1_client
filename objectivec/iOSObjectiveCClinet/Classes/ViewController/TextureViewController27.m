...
// ======================================================================
#import "TextureViewController27.h"
...
@interface TextureViewController27 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour27*>* behaviours;
@end
@implementation TextureViewController27
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour27*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour27* behaviour = [[TextureBehaviour27 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour27* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
