...
// ======================================================================
#import "TextureViewController11.h"
...
@interface TextureViewController11 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour11*>* behaviours;
@end
@implementation TextureViewController11
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    TextureBehaviour11* behaviour2 = [[TextureBehaviour11 alloc] init:1];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour11* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
