...
// ======================================================================
#import "RectangleViewController4.h"
...
@interface RectangleViewController4 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<RectangleBehaviour4*>* behaviours;
@end
@implementation RectangleViewController4
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<RectangleBehaviour4*> alloc] init];
    for (int i = 0; i < 1; i++) {
        RectangleBehaviour4* behaviour = [[RectangleBehaviour4 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (RectangleBehaviour4* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
