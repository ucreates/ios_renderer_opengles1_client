...
// ======================================================================
#import "ShaderViewController1.h"
...
@interface ShaderViewController1 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<ShaderBehaviour2*>* behaviours;
@end
@implementation ShaderViewController1
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<ShaderBehaviour2*> alloc] init];
    for (int i = 0; i < 1; i++) {
        ShaderBehaviour2* behaviour = [[ShaderBehaviour2 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (ShaderBehaviour2* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
