...
// ======================================================================
#import "TextureViewController23.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour23.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController23 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour23*>* behaviours;
@end
@implementation TextureViewController23
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour23*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour23* behaviour = [[TextureBehaviour23 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour23* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
