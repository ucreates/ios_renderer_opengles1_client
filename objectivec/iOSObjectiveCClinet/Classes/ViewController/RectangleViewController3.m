...
// ======================================================================
#import "RectangleViewController3.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "RectangleBehaviour3.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface RectangleViewController3 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<RectangleBehaviour3*>* behaviours;
@end
@implementation RectangleViewController3
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<RectangleBehaviour3*> alloc] init];
    for (int i = 0; i < 1; i++) {
        RectangleBehaviour3* behaviour = [[RectangleBehaviour3 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (RectangleBehaviour3* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
