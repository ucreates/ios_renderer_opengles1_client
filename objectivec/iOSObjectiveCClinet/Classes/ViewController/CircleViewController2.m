...
// Circle1
// ======================================================================
#import "CircleViewController2.h"
...
@interface CircleViewController2 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<CircleBehaviour2*>* behaviours;
@end
@implementation CircleViewController2
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<CircleBehaviour2*> alloc] init];
    for (int i = 0; i < 1; i++) {
        CircleBehaviour2* behaviour = [[CircleBehaviour2 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (CircleBehaviour2* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
