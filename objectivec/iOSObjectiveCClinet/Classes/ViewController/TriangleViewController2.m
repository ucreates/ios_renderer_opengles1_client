...
// Triangle1
// ======================================================================
#import "TriangleViewController2.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TriangleBehaviour2.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TriangleViewController2 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TriangleBehaviour2*>* behaviours;
@end
@implementation TriangleViewController2
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TriangleBehaviour2*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TriangleBehaviour2* behaviour = [[TriangleBehaviour2 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TriangleBehaviour2* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
