...
// ======================================================================
#import "TextureViewController18.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour18.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController18 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour18*>* behaviours;
@end
@implementation TextureViewController18
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour18*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour18* behaviour = [[TextureBehaviour18 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour18* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
