...
// ======================================================================
#import "TextureViewController6.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour6.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController6 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour6*>* behaviours;
@end
@implementation TextureViewController6
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour6*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour6* behaviour = [[TextureBehaviour6 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour6* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
