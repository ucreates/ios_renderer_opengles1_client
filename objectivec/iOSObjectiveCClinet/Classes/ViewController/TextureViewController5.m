...
// ======================================================================
#import "TextureViewController5.h"
...
@interface TextureViewController5 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour5*>* behaviours;
@end
@implementation TextureViewController5
@synthesize renderer;
