...
// ======================================================================
#import "TextureViewController19.h"
...
@interface TextureViewController19 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour19*>* behaviours;
@end
@implementation TextureViewController19
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour19*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour19* behaviour = [[TextureBehaviour19 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour19* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
