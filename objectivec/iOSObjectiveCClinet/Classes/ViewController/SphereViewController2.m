...
// ======================================================================
#import "SphereViewController2.h"
...
@interface SphereViewController2 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<SphereBehaviour2*>* behaviours;
@end
@implementation SphereViewController2
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<SphereBehaviour2*> alloc] init];
    for (int i = 0; i < 1; i++) {
        SphereBehaviour2* behaviour = [[SphereBehaviour2 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (SphereBehaviour2* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
