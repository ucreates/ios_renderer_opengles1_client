...
// ======================================================================
#import "TextureViewController15.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour15.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController15 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour15*>* behaviours;
@end
@implementation TextureViewController15
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour15*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour15* behaviour = [[TextureBehaviour15 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour15* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
