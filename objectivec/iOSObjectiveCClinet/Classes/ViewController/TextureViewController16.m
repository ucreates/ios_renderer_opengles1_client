...
// Cube1
// ======================================================================
#import "TextureViewController16.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour16.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController16 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour16*>* behaviours;
@end
@implementation TextureViewController16
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour16*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour16* behaviour = [[TextureBehaviour16 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour16* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
