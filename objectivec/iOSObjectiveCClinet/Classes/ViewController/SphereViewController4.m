...
// ======================================================================
#import "SphereViewController4.h"
...
@interface SphereViewController4 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<SphereBehaviour4*>* behaviours;
@end
@implementation SphereViewController4
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<SphereBehaviour4*> alloc] init];
    for (int i = 0; i < 1; i++) {
        SphereBehaviour4* behaviour = [[SphereBehaviour4 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (SphereBehaviour4* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
