...
// ======================================================================
#import "TextureViewController22.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour22.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController22 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour22*>* behaviours;
@end
@implementation TextureViewController22
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour22*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour22* behaviour = [[TextureBehaviour22 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour22* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
