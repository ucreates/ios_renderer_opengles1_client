...
// ======================================================================
#import "TextureViewController20.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour20.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController20 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour20*>* behaviours;
@end
@implementation TextureViewController20
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour20*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour20* behaviour = [[TextureBehaviour20 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour20* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
