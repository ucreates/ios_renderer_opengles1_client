...
// ======================================================================
#import "TextureViewController2.h"
...
@interface TextureViewController2 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour2*>* behaviours;
@end
@implementation TextureViewController2
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour2*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour2* behaviour = [[TextureBehaviour2 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour2* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
