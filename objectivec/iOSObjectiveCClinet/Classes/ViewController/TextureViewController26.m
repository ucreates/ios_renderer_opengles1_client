...
// ======================================================================
#import "TextureViewController26.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour26.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController26 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour26*>* behaviours;
@end
@implementation TextureViewController26
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour26*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour26* behaviour = [[TextureBehaviour26 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour26* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
