...
// ======================================================================
#import "TextureViewController24.h"
...
@interface TextureViewController24 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour24*>* behaviours;
@end
@implementation TextureViewController24
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour24*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour24* behaviour = [[TextureBehaviour24 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour24* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
