...
// ======================================================================
#import "TextureViewController17.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour17.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController17 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour17*>* behaviours;
@end
@implementation TextureViewController17
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour17*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour17* behaviour = [[TextureBehaviour17 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour17* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
