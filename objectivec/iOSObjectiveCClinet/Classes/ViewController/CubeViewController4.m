...
// ======================================================================
#import "CubeViewController4.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "CubeBehaviour4.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface CubeViewController4 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<CubeBehaviour4*>* behaviours;
@end
@implementation CubeViewController4
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<CubeBehaviour4*> alloc] init];
    for (int i = 0; i < 1; i++) {
        CubeBehaviour4* behaviour = [[CubeBehaviour4 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (CubeBehaviour4* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
