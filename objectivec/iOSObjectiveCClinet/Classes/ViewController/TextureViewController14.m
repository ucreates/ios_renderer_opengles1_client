...
// ======================================================================
#import "TextureViewController14.h"
#import <GLKit/GLKit.h>
#import <OpenGLES/ES1/gl.h>
#import <OpenGLES/ES1/glext.h>
#import "TextureBehaviour14.h"
#import "iOSObjectiveCFoundation.h"
#import "iOSObjectiveCGLES1Renderer.h"
@interface TextureViewController14 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour14*>* behaviours;
@end
@implementation TextureViewController14
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour14*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour14* behaviour = [[TextureBehaviour14 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour14* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
