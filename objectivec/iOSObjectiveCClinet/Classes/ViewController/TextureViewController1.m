...
// ======================================================================
#import "TextureViewController1.h"
...
@interface TextureViewController1 ()
@property GLES1Renderer* renderer;
@property NSMutableArray<TextureBehaviour1*>* behaviours;
@end
@implementation TextureViewController1
@synthesize renderer;
...
- (void)viewDidLoad {
    ...
    self->behaviours = [[NSMutableArray<TextureBehaviour1*> alloc] init];
    for (int i = 0; i < 1; i++) {
        TextureBehaviour1* behaviour = [[TextureBehaviour1 alloc] init];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    for (TextureBehaviour1* behaviour in self->behaviours) {
        [behaviour onDestroy];
    }
